...
+ 'background:radial-gradient(120% 80% at 50% -10%, #fdf6e9 0%, #f6ede0 40%, #efe6d6 100%);'
+ 'opacity:0;transition:opacity .28s ease;overflow:hidden;color:#2c2519;}'
+ '.rgen-overlay.open{opacity:1;}'
+ 'body.dark .rgen-overlay{background:radial-gradient(120% 80% at 50% -10%, #232a33 0%, #1b2129 45%, #161b21 100%);color:#e9e4d6;}'
+ '.rgen-topbar{flex:0 0 auto;display:flex;align-items:center;gap:10px;padding:14px 16px calc(10px + env(safe-area-inset-top,0)) 16px;'
+ 'padding-top:calc(14px + env(safe-area-inset-top,0));position:relative;z-index:3;}'
+ '.rgen-title{font-family:"Patrick Hand",system-ui,cursive;font-size:1.55rem;line-height:1;margin:0;letter-spacing:.3px;}'
+ '.rgen-sub{font-size:.72rem;opacity:.72;margin-top:2px;font-family:system-ui,sans-serif;}'
+ '.rgen-x{margin-left:auto;width:40px;height:40px;border:none;border-radius:50%;cursor:pointer;'
+ 'background:rgba(0,0,0,.06);color:inherit;display:grid;place-items:center;flex:0 0 auto;}'
+ 'body.dark .rgen-x{background:rgba(255,255,255,.1);}'
+ '.rgen-x:hover{background:rgba(0,0,0,.12);} body.dark .rgen-x:hover{background:rgba(255,255,255,.18);}'
...
+ '.rgen-era .dot{width:12px;height:12px;border-radius:50%;flex:0 0 auto;box-shadow:0 0 0 3px rgba(255,255,255,.5);}'
+ '.rgen-era .ln{flex:1 1 auto;height:2px;border-radius:2px;opacity:.5;}'
+ '.rgen-node{position:relative;display:flex;justify-content:center;}'
+ '.rgen-connector{display:block;width:4px;height:26px;margin:0 auto;border-radius:4px;background:linear-gradient(#cdbfa6,#cdbfa6);opacity:.9;}'
+ 'body.dark .rgen-connector{background:#3d4653;}'
...
+ 'background:var(--rgen-soft,#fff);box-shadow:0 6px 20px rgba(60,45,20,.12),0 1px 0 rgba(255,255,255,.6) inset;'
+ 'border:2px solid var(--rgen-accent,#ddd);cursor:pointer;transition:transform .16s ease,box-shadow .16s ease;text-align:left;}'
+ 'body.dark .rgen-card{background:#232a33;box-shadow:0 8px 22px rgba(0,0,0,.4);}'
+ '.rgen-card:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(60,45,20,.2);}'
+ '.rgen-card:active{transform:scale(.99);}'
+ '.rgen-card.spine{max-width:460px;}'
+ '.rgen-ava{flex:0 0 auto;width:78px;height:78px;border-radius:50%;overflow:hidden;position:relative;background:#eee;}'
...
+ 'body.dark .rgen-ava .tap{border-color:#232a33;}'
+ '.rgen-ava .tap .material-symbols-outlined{font-size:16px;}'
+ '.rgen-meta{flex:1 1 auto;min-width:0;}'
+ '.rgen-name{font-family:"Patrick Hand",cursive;font-size:1.32rem;line-height:1.05;margin:0;display:flex;align-items:baseline;gap:8px;flex-wrap:wrap;}'
...
+ '.rgen-facts{list-style:none;margin:6px 0 0;padding:0;display:flex;flex-wrap:wrap;gap:4px 12px;font-size:.78rem;opacity:.86;}'
+ '.rgen-facts li{display:flex;align-items:center;gap:4px;}'
+ '.rgen-facts .material-symbols-outlined{font-size:15px;opacity:.7;}'
+ '.rgen-blurb{margin:7px 0 0;font-size:.82rem;line-height:1.34;opacity:.9;}'
...
+ 'background:rgba(255,255,255,.7);border:1.5px dashed var(--rgen-accent,#ccc);font-size:.8rem;font-weight:600;color:inherit;}'
+ 'body.dark .rgen-branch-chip{background:rgba(255,255,255,.08);}'
+ '.rgen-branch-chip:hover{background:#fff;} body.dark .rgen-branch-chip:hover{background:rgba(255,255,255,.16);}'
...
+ '.rgen-branch-label{display:flex;align-items:center;gap:4px;justify-content:center;margin:12px auto 2px;font-size:.72rem;opacity:.6;'
+ 'text-transform:uppercase;letter-spacing:.6px;font-weight:600;}'
+ '.rgen-highlight .rgen-card{animation:rgenPulse 1.6s ease 2;}'
+ '@keyframes rgenPulse{0%,100%{box-shadow:0 6px 20px rgba(60,45,20,.12);}50%{box-shadow:0 0 0 5px var(--rgen-accent),0 12px 30px rgba(60,45,20,.28);}}'
// intro
+ '.rgen-intro{text-align:center;max-width:520px;margin:8px auto 4px;}'
+ '.rgen-intro p{font-size:.9rem;line-height:1.4;opacity:.82;margin:6px 0 0;}'
+ '.rgen-legend{display:flex;flex-wrap:wrap;gap:6px 12px;justify-content:center;margin:14px auto 0;font-size:.72rem;opacity:.8;}'
...
+ 'background:#fbf4e6;border-radius:26px 26px 0 0;transform:translateY(24px);transition:transform .26s cubic-bezier(.2,.9,.3,1);'
...
+ 'body.dark .rgen-sheet-card{background:#1f252d;color:#e9e4d6;}'
...
+ '.rgen-hero-name{font-family:"Patrick Hand",cursive;font-size:2rem;line-height:1;margin:0;}'
...
+ '.rgen-qf{background:rgba(0,0,0,.04);border-radius:14px;padding:9px 12px;}'
+ 'body.dark .rgen-qf{background:rgba(255,255,255,.06);}'
+ '.rgen-qf .k{font-size:.62rem;text-transform:uppercase;letter-spacing:.6px;opacity:.6;font-weight:700;display:flex;align-items:center;gap:4px;}'
...
+ 'background:rgba(0,0,0,.05);border:none;color:inherit;font-size:.8rem;font-weight:600;}'
+ 'body.dark .rgen-relchip{background:rgba(255,255,255,.08);}'
+ '.rgen-relchip:hover{background:rgba(0,0,0,.1);} body.dark .rgen-relchip:hover{background:rgba(255,255,255,.15);}'
...
+ '.rgen-relchip small{display:block;font-size:.6rem;opacity:.6;font-weight:700;text-transform:uppercase;letter-spacing:.4px;}'
+ '.rgen-sech{font-family:"Patrick Hand",cursive;font-size:1.2rem;margin:20px 0 8px;display:flex;align-items:center;gap:7px;}'
+ '.rgen-sech .material-symbols-outlined{font-size:20px;opacity:.7;}'
+ '.rgen-verse{display:block;width:100%;text-align:left;background:rgba(0,0,0,.03);border:1px solid rgba(0,0,0,.06);'
+ 'border-radius:14px;padding:11px 13px;margin-bottom:9px;cursor:pointer;color:inherit;}'
+ 'body.dark .rgen-verse{background:rgba(255,255,255,.05);border-color:rgba(255,255,255,.08);}'
+ '.rgen-verse:hover{background:rgba(0,0,0,.06);} body.dark .rgen-verse:hover{background:rgba(255,255,255,.1);}'
+ '.rgen-verse .ref{font-weight:700;font-size:.86rem;display:flex;align-items:center;gap:6px;color:var(--rgen-accent,#8a5a12);}'
+ 'body.dark .rgen-verse .ref{color:var(--rgen-accent2,#e0b566);}'
+ '.rgen-verse .ref .material-symbols-outlined{font-size:15px;}'
+ '.rgen-verse .q{font-size:.84rem;line-height:1.34;margin-top:3px;opacity:.9;}'
+ '.rgen-verse .go{float:right;font-size:.66rem;opacity:.5;font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-top:2px;}'
...
// reader icon
+ '.rhema-reader-genealogy-btn{--rgen-accent:#8a5a12;}'
+ '.rgen-toast{position:fixed;left:50%;bottom:26px;transform:translateX(-50%) translateY(20px);z-index:4400;'
+ 'background:#2c2519;color:#fdf4e0;padding:10px 16px;border-radius:999px;font-size:.82rem;opacity:0;transition:all .25s ease;pointer-events:none;box-shadow:0 8px 24px rgba(0,0,0,.3);}'
